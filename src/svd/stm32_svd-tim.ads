...
package STM32_SVD.TIM is
   ...
   --  Advanced-timers
   TIM1_Periph : aliased TIM1_Peripheral with
      Import,
      Address => TIM1_Base;
   ...
   --  General-purpose-timers
   TIM2_Periph : aliased TIM2_Peripheral with
      Import,
      Address => TIM2_Base;

      --  General-purpose-timers
   TIM3_Periph : aliased TIM2_Peripheral with
      Import,
      Address => TIM3_Base;
   ...
   --  Basic-timers
   TIM6_Periph : aliased TIM6_Peripheral with
      Import,
      Address => TIM6_Base;

      --  Basic-timers
   TIM7_Periph : aliased TIM6_Peripheral with
      Import,
      Address => TIM7_Base;
   ...
   --  General-purpose-timers
   TIM14_Periph : aliased TIM14_Peripheral with
      Import,
      Address => TIM14_Base;
   ...
   --  General-purpose-timers
   TIM15_Periph : aliased TIM15_Peripheral with
      Import,
      Address => TIM15_Base;
   ...
   --  General-purpose-timers
   TIM16_Periph : aliased TIM16_Peripheral with
      Import,
      Address => TIM16_Base;

      --  General-purpose-timers
   TIM17_Periph : aliased TIM16_Peripheral with
      Import,
      Address => TIM17_Base;
