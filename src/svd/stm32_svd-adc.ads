...
package STM32_SVD.ADC is
   ...
   type CFGR2_JITOFF_D_Field_Array is array (2 .. 3) of Boolean with
      Component_Size => 1,
      Size           => 2;
   ...
   --  CHSELR_CHSEL array
   type CHSELR_CHSEL_Field_Array is array (0 .. 18) of Boolean with
      Component_Size => 1,
      Size           => 19;
   ...
   --  Analog-to-digital converter
   ADC_Periph : aliased ADC_Peripheral with
      Import,
      Address => ADC_Base;
