...
package STM32_SVD.EXTI is
   ...
   --  IMR_MR array
   type IMR_MR_Field_Array is array (0 .. 27) of Boolean with
      Component_Size => 1,
      Size           => 28;
   ...
   --  EMR_MR array
   type EMR_MR_Field_Array is array (0 .. 27) of Boolean with
      Component_Size => 1,
      Size           => 28;
   ...
   --  RTSR_TR array
   type RTSR_TR_Field_Array is array (0 .. 17) of Boolean with
      Component_Size => 1,
      Size           => 18;
   ...
   --  FTSR_TR array
   type FTSR_TR_Field_Array is array (0 .. 17) of Boolean with
      Component_Size => 1,
      Size           => 18;
   ...
   --  SWIER array
   type SWIER_Field_Array is array (0 .. 17) of Boolean with
      Component_Size => 1,
      Size           => 18;
   ...
   --  PR_PIF array
   type PR_PIF_Field_Array is array (0 .. 17) of Boolean with
      Component_Size => 1,
      Size           => 18;
   ...
   --  PR_PIF array
   type PR_PIF_Field_Array_1 is array (19 .. 22) of Boolean with
      Component_Size => 1,
      Size           => 4;
   ...
   --  External interrupt/event controller
   EXTI_Periph : aliased EXTI_Peripheral with
      Import,
      Address => EXTI_Base;
