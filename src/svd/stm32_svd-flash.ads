...
package STM32_SVD.Flash is
   ...
   --  OBR_nBOOT array
   type OBR_nBOOT_Field_Array is array (0 .. 1) of Boolean with
      Component_Size => 1,
      Size           => 2;
   ...
   --  OBR_Data array
   type OBR_Data_Field_Array is array (0 .. 1) of OBR_Data_Element with
      Component_Size => 8,
      Size           => 16;
   ...
   --  Flash
   Flash_Periph : aliased Flash_Peripheral with
      Import,
      Address => Flash_Base;
